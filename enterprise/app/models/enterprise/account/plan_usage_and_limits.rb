module Enterprise::Account::PlanUsageAndLimits
  ...
  def subscribed_features
    # Nokk: Return all premium features
    %w[sla captain_integration custom_roles audit_logs help_center saml]
  end
